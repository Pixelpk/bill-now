    ...
    newRow: function () {
        jQuery(".item-row:last").after(`
            <tr class="item-row new-item">
                ...
                <td width="30%">
                    <input class="form-control" placeholder="Enter item description" type="text" name="details[]" value="">
                </td>
                <td width="15%"><input class="form-control price invo" name="price[]" placeholder="Price" type="text"> </td>
                <td width="10%"><input class="form-control qty" name="quantity[]" placeholder="Qty" type="text"></td>
