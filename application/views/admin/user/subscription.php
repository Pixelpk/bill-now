                ...
                <div class="box add_area">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo trans('subscription') ?>
                            ...
                            <a target="_blank" href="<?php echo base_url('admin/payment/lists') ?>"
                               class="pull-right btn btn-default btn-xs mt-5 brd-30"><i
                                        class="fa fa-file-text-o"></i> <?php echo trans('view-invoice') ?></a>
                        </h3>
                    </div>

                    <div class="box-body">
                        <p><?php echo trans('your-subscription') ?>:
                            <strong><?php echo html_escape($user->package_name) ?><?php echo trans('plan') ?></strong>
                        </p>
                        <p><?php echo trans('price') ?>:
                            <strong><?php echo html_escape($user->amount) ?><?php echo html_escape($settings->currency) ?></strong>
                        </p>
                        <p><?php echo trans('billing-frequency') ?> :
                            <strong><?php echo ucfirst(html_escape($user->billing_type)) ?></strong></p>
                        <p><?php echo trans('last-billing') ?> :
                            <strong><?php echo my_date_show($user->created_at) ?></strong></p>
                        <p><?php echo trans('next-billing') ?> :
                            <strong><?php echo my_date_show($user->expire_on); ?></strong>
                            <strong class="text-danger">(<?php echo date_dif(date('Y-m-d'), $user->expire_on) ?> <?php echo trans('days-left') ?>
                                )</strong></strong></p>
                    </div>
                    <div class="box-footer text-center soft-<?php if ($user->status == 'verified') {
                        ...
                        <?php echo trans('payment-status') ?>: &emsp; <i
                                class="fa fa-<?php if ($user->status == 'verified') {
                                    echo "check";
                                } else {
                                    echo "times";
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 scroll">
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr class="monthly_row" style="display: <?php if ($user->billing_type == 'yearly') {
                                        ...
                                        foreach ($packages as $package): ?>
                                            <td class="text-center">
                                                <h2 class="mt-10"><?php if ($user->package == $package->id && $user->billing_type == 'monthly') {
                                                        echo '<i class="fa fa-check-circle text-success"></i><br>';
                                    ...
                                    <tr class="yearly_row" style="display: <?php if ($user->billing_type == 'monthly') {
                                        ...
                                        foreach ($packages as $package): ?>
                                            <td class="text-center">
                                                <h2 class="mt-10"><?php if ($user->package == $package->id && $user->billing_type == 'yearly') {
                                                        echo '<i class="fa fa-check-circle text-success"></i><br>';
                                                    } ?><?php echo html_escape($package->name); ?></h2>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($feature->basic == 0): ?>
                                                        <p class="mb-0 feature-item"><i
                                                                    class="fa fa-times text-danger"></i></p>
                                            ...
                                            <td class="<?php if ($b == 2) {
                                                ...
                                                <a href="<?php echo base_url('admin/subscription/upgrade/' . $package->slug) ?>"
                                                   class="btn btn-<?php if ($b == 2) {
                                                       ...
                                                       echo "default";
                                                   } ?> package_btn <?= ($user->package == $package->id && $user->billing_type == 'monthly') ? "disabled" : "" ?>"
                                                >
                                            ...
                                            <td class="<?php if ($b == 2) {
                                                ...
                                                <a href="<?php echo base_url('admin/subscription/upgrade/' . $package->slug) ?>"
                                                   class="btn btn-<?php if ($b == 2) {
                                                       ...
                                                       echo "default";
                                                   } ?> package_btn <?= ($user->package == $package->id && $user->billing_type == 'yearly') ? "disabled" : "" ?>"
                                                >
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title text-warning"><i class="text-dark fa fa-bullhorn"></i> Important Notice about
                    Subscription <i class="text-dark fa fa-bullhorn"></i></h3>
            </div>
            <div class="modal-body">
                <ul>
                    <li>Package Purchased will overwrite the previous package.</li>
                    <li>New Package purchased will not add the remaining days of the package, but will contain only its
                        days.
                    </li>
                    <li>Same package can be purchased and you need to be careful about upgrading the package.</li>
                </ul>
            </div>
