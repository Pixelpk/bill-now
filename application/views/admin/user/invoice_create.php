                                  ...
                                  <div class="panel-body inv">                      
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php else: ?>
                                                <textarea id="summernote" class="form-control" rows="8" name="footer_note" placeholder="<?php echo trans('invoice-footer-placeholder') ?>"><?php echo strip_tags($this->business->footer_note) ?></textarea>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                  </div>
